/** 
 * This program prompts the user to enter 6 integers separated by a blank space. 
 * Then, it displays the integers in tabular 3 rows by 2 columns format with the respective
 * sums for the given row and column, indicated by the two "Total" headers. 
 * The total sum is printed in the bottom right hand corner.
 * @author Neil Kapoor
*/
